...
* [Semantically preserving, order-preserving frontmatter](lossless-frontmatter.md) - Frontmatter keeps unknown keys, values, and order while YAML presentation may normalize.
