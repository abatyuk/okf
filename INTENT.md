...
```jsonl
{"kind":"schema","tool":"okf","tool_version":"0.2.7","okf_spec":["0.2"],"ndjson_schema":"2","global_args":[{"name":"json","type":"bool","default":false}],"bundle_resolution":["explicit","env:OKF_BUNDLE","config:okf.toml","cwd"]}
